#!/bin/sh
set -e
# Code originally generated by godownloader on 2019-12-19T22:42:25Z.
# Edited 2019-12-30 to add version check to the executable naming, which changed
# Edited 2022-05-14 to enable target platforms and simplify a bit
