...
Usage: $this [-d] [-o OS] [outdir] [tag]
  -d turns on debug logging
  -o [OS] is a OS to download, defaults to host OS
  [outdir] directory to put files into
  [tag] is a tag from https://github.com/mozilla/sops/releases
    If tag is missing, then the latest release will be used.

Adapted from godownloader https://github.com/goreleaser/godownloader
